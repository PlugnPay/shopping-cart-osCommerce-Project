...
Packages cover hosted Smart Screens checkout for credit card and ACH / eCheck.

## Downloads by osCommerce Project version

### osCommerce Project v2.2.x (legacy)

* **Smart Screens (Credit Card)** — hosted CC checkout
  - [Download](./osCommerce-Project_v2.2.x/oscproject_2.2_cc_ss_module.zip)
...
* **Smart Screens (ACH)** — hosted ACH / eCheck checkout
  - [Download](./osCommerce-Project_v2.2.x/oscproject_2.2_ach_ss_module.zip)
...
### osCommerce Project 2.2.x — Smart Screens (Credit Card)

1. Download [oscproject_2.2_cc_ss_module.zip](./osCommerce-Project_v2.2.x/oscproject_2.2_cc_ss_module.zip).
2. Copy files under `catalog_root/` into the matching paths of your cart root.
3. Admin → Modules → Payment → install/configure **PlugnPay CC Smart Screens** (`plugnpay_cc_ss`).

- Quick install: [osCommerce-Project_v2.2.x/INSTALL_SS_CC.txt](./osCommerce-Project_v2.2.x/INSTALL_SS_CC.txt)

### osCommerce Project 2.2.x — Smart Screens (ACH)

1. Download [oscproject_2.2_ach_ss_module.zip](./osCommerce-Project_v2.2.x/oscproject_2.2_ach_ss_module.zip).
2. Copy files under `catalog_root/` into the matching paths of your cart root.
3. Admin → Modules → Payment → install/configure **PlugnPay ACH Smart Screens** (`plugnpay_ach_ss`).
...
### Smart Screens (hosted)

* Hosted billing on PlugnPay; the cart does not collect sensitive payment data.
* Card or ACH details are entered on PlugnPay SSL-secured billing pages.
* Separate packages are available for credit card and ACH / eCheck.
* In PlugnPay Account Settings, enable the transition page and set Transition Page Type to `post`.
...
shopping-cart-osCommerce-Project/
  ...
  osCommerce-Project_v2.2.x/          # legacy (2.2) — Smart Screens CC + ACH
    README.md
    INSTALL_SS_CC.txt
    INSTALL_SS_ACH.txt
...
Provided AS IS. These modules are discontinued; prefer the current [osCommerce modules](https://github.com/PlugnPay/shopping-cart-osCommerce). See [PlugnPay docs](https://docs.plugnpay.com/) for integration details.
