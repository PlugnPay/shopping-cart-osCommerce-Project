...
// class constructor
    function plugnpay_cc_ss() {
      ...
      $this->signature = 'plugnpay|plugnpay_cc_ss|2.0|2.2';
      ...
      foreach ($cc_array as $value) {
        if (isset($this->card_types[$value])) {
...
// class methods
    ...
    function process_button() {
      ...
      $cc_allowed_types = rtrim($cc_allowed_types, ',');
      ...
      # Smart Screens v2 fields (see docs.plugnpay.com Smart Screens v2 specs)
      $process_button_string = tep_draw_hidden_field('pt_gateway_account', MODULE_PAYMENT_PLUGNPAY_CC_SS_LOGIN) .
                               tep_draw_hidden_field('pb_confirmation_sending_email_address', MODULE_PAYMENT_PLUGNPAY_CC_SS_PUBEMAIL) .
                               tep_draw_hidden_field('pt_client_identifier', 'osCP_CC_SS2') .
                               tep_draw_hidden_field('pd_transaction_payment_type', 'credit') .
                               tep_draw_hidden_field('pb_cards_allowed', $cc_allowed_types) .
    ...
    function install() {
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Enable PlugnPay Credit Card SS v2', 'MODULE_PAYMENT_PLUGNPAY_CC_SS_STATUS', 'False', 'Do you want to accept PlugnPay Credit Card Smart Screens v2 payments?', '6', '0', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
    ...
    function keys() {
      return array('MODULE_PAYMENT_PLUGNPAY_CC_SS_STATUS', 'MODULE_PAYMENT_PLUGNPAY_CC_SS_LOGIN', 'MODULE_PAYMENT_PLUGNPAY_CC_SS_PUBEMAIL', 'MODULE_PAYMENT_PLUGNPAY_CC_SS_ZONE', 'MODULE_PAYMENT_PLUGNPAY_CC_SS_ORDER_STATUS_ID', 'MODULE_PAYMENT_PLUGNPAY_CC_SS_SORT_ORDER', 'MODULE_PAYMENT_PLUGNPAY_CC_SS_ACCEPTED');
    }
...
// format prices without currency formatting
  ...
  if (!function_exists('_selectOptions')) {
